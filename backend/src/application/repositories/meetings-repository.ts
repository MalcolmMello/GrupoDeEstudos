...
export abstract class MeetingsRepository {
  ...
  abstract cancelPresence(idStudent: string, idMeeting: string, idHost: string): Promise<void>;
  abstract studentScheduledMeetings(idStudent: string, subject?: string, description?: string, semester?: number, date_hour?: Date): Promise<Meeting[]>;
  abstract hostMeetings(idHost: string, subject?: string, description?: string, semester?: number, date_hour?: Date): Promise<Meeting[]>;
